...
export async function getMoviePerson(movie_id) {
  try {
...
export async function getMovieActorsPerson(movie_id) {
  try {
...
export async function getMoviePersonRecommendations(movie_id) {
  try {
...
export async function displayMoviePerson(data) {
...
export  function displayMovieActorsPerson(data) {
  const { cast } = data;
...
export  function displayMoviePersonRecommendations(data) {
  const { results } = data;
